                        ...
                        <div className="owl-carousel product-slider" data-item="4">
                                ...
                                <div className="product-o product-o--hover-on">
                                    <div className="product-o__wrap">
                                        <a className="aspect aspect--bg-grey aspect--square u-d-block" href="product-#">
                                            <img className="aspect__img" src={product3} alt="" />
                                        </a>
                                        <div className="product-o__action-wrap">
                                            <ul className="product-o__action-list">
                                                ...
                                                <li>
                                                    <a href="#" data-tooltip="tooltip" data-placement="top" title="Email me When the price drops">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Nikon DSLR 4K Camera</a>
                                    </span>
                            ...
                            <div className="u-s-m-b-30">
                                <div className="product-o product-o--hover-on">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Nikon DSLR 2K Camera</a>
                                    </span>
                                    <div className="product-o__rating gl-rating-style">
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
                            ...
                            <div className="u-s-m-b-30">
                                <div className="product-o product-o--hover-on">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Sony DSLR 4K Camera</a>
                                    </span>
                                    <div className="product-o__rating gl-rating-style">
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
                            ...
                            <div className="u-s-m-b-30">
                                <div className="product-o product-o--hover-on">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Sony DSLR 2K Camera</a>
                                    </span>
                                    <div className="product-o__rating gl-rating-style">
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
                            ...
                            <div className="u-s-m-b-30">
                                <div className="product-o product-o--hover-on">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Canon DSLR 4K Camera</a>
                                    </span>
                                    <div className="product-o__rating gl-rating-style">
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
                            ...
                            <div className="u-s-m-b-30">
                                <div className="product-o product-o--hover-on">
                                    ...
                                    <span className="product-o__name">
                                        <a href="product-#">Canon DSLR 2K Camera</a>
                                    </span>
                                    <div className="product-o__rating gl-rating-style">
                                        <i className="far fa-star"></i>
                                        <i className="far fa-star"></i>
