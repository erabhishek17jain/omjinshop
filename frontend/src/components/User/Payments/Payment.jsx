...
import PriceSidebar from '../Orders/Shipping/PriceSidebar';
...
import { clearErrors } from '../../../middleware/actions/orderAction';
...
const Payment = () => {
    ...
    return (
        <>
            <MetaData title="Omjinshop: Secure Payment | Paytm" />
                            ...
                            <div className="w-full bg-white">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        className={`${
                                            payDisable ? 'bg-primary-grey cursor-not-allowed' : 'bg-primary-orange cursor-pointer'
