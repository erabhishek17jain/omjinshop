    ...
    return (
            ...
            <div className="dash__box dash__box--bg-white dash__box--shadow u-s-m-b-30">
                <div className="dash__pad-1">
                    <div className="description__container u-s-m-b-16">
                        <img draggable="false" className="sidebar-avatar object-cover rounded-full" src={user.avatar.url} alt="Avatar" />
                        <span className="gl-label u-s-m-l-16 u-s-m-b-16">Hello, {user.name.toUpperCase()}</span>
                    </div>
                    <ul className="dash__f-list">
                        ...
                        <li>
                            <Link to="/account/profile" className={activeTab === 'profile' ? 'dash-active' : ''}>
                                Profile
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/wishlist" className={activeTab === 'wishlist' ? 'dash-active' : ''}>
                                Wishlist
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/orders" className={activeTab === 'orders' ? 'dash-active' : ''}>
                                Orders
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/trackOrder" className={activeTab === 'trackOrder' ? 'dash-active' : ''}>
                                Track Order
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/addressBook" className={activeTab === 'addressBook' ? 'dash-active' : ''}>
                                Address Book
                            </Link>
                        </li>
                        <li>
                        ...
                        {/* <li>
                            <Link to="/account/reviews" className={activeTab === 'reviews' ? 'dash-active' : ''}>
                                Reviews &amp; Ratings
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/paymentOption" className={activeTab === 'paymentOption' ? 'dash-active' : ''}>
                                Payment Options
                            </Link>
                        </li>
                        <li>
                            <Link to="/account/panCardDetails" className={activeTab === 'panCardDetails' ? 'dash-active' : ''}>
        ...
        <div className="flex flex-col bg-white rounded-sm shadow">
          <div className="flex items-center gap-5 px-4 py-4 border-b">
            ...
            <Link className="flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue" to="/account/orders">
              MY ORDERS
              <span>
                <ChevronRightIcon />
              </span>
