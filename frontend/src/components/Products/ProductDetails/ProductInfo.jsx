            ...
            <div className='row'>
                <div className='col-lg-5'>
                    <div className='pd-breadcrumb u-s-m-b-30'>
                        <CategoryHerirarcy category={product.category} />
                    </div>
                                ...
                                <div className='u-s-m-b-15'>
                                    ...
                                    <div className='pd-detail__color'>
                                        ...
                                        <div className='color__radio'>
                                            ...
                                            <label className='color__radio-label' htmlFor='granite-gray' style={{ backgroundColor: '#605F5E' }}></label>
                                        </div>
                                        <div className='color__radio'>
                                            <input type='radio' id='space-cadet' name='color' />
                                            <label className='color__radio-label' htmlFor='space-cadet' style={{ backgroundColor: '#1D3461' }}></label>
                                        </div>
                                    </div>
                                </div>
                                <div className='u-s-m-b-15'>
